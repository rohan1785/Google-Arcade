...
#  Created by Texh With Ro
#  YouTube: https://www.youtube.com/@ro_patil
# ==============================================
...
echo "${BLUE}${BOLD}║        by Tech With Ro            ║${RESET}"
echo "${BLUE}${BOLD}╚══════════════════════════════════════════╝${RESET}"
echo
...
echo "${BLUE}https://www.youtube.com/@ro_patil:${RESET}"
echo
...
echo
echo "${MAGENTA}For more, subscribe to:${RESET}"
echo "${BLUE}https://www.youtube.com/@ro_patil :${RESET}"
echo
